...
_16n.is_sysex_config_dump = function(sysex_payload)
   return (sysex_payload[2] == 0x7d and sysex_payload[3] == 0x00 and sysex_payload[4] == 0x00 and sysex_payload[5] == 0x0f)
end
...
_16n.parse_sysex_config_dump = function(sysex_payload)
   ...
   for fader_i = 0, 16 - 1 do
      table.insert(usb_cc_list, sysex_payload[i + 64 + fader_i])
   end
...
_16n.cc_2_slider_id = function(cc)
   ...
   -- 2. Fallback: CC 32-47 -> faders 1-16
   if id == nil then
